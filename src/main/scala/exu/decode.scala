...
object XDecode extends DecodeConstants
{
  ...
  BLND    -> List(Y, N, X, uopBLND_1 , IQT_MEM, FU_MEM, RT_X  , RT_FIX, RT_X  , N, IS_S, N, Y, N, N, N, M_XWR   , 0.U, N, N, N, N, N, CSR.N),
  RBLND   -> List(Y, N, X, uopRBLND_1, IQT_MEM, FU_MEM, RT_X  , RT_FIX, RT_X  , N, IS_S, N, Y, N, N, N, M_XWR   , 0.U, N, N, N, N, N, CSR.N)
  )
}
